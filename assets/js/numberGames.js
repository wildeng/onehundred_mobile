...
var notifications = {
  init: function(){
    $('#dialogAlert').popup();
    $('#dialogGameover').popup();
    $('#dialogWinner').popup();
  },
  
  alerting: function(message,title){
    
    $('#dialogAlert').attr("title",title);
  ...
  gameOver: function(){
    $('#popupGameover').html('The game is over. Do you want to play again?');
    $('#dialogGameover').popup('open');
  },

  winnerIs: function(){
    $('#popupWinner').html('Congratulations, you won the game. Do you want to play again?');
    $('#notify').dialog('open');
    $('#dialogWinner').popup('open');
  }
}
